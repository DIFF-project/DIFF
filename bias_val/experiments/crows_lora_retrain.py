...
if __name__ == "__main__":
    ...
    if args.model_name == "facebook/opt-1.3b":
      ...
      adapter_model_dir = adapter_model_dir = f"../bias_sel/Qwen/Qwen_{config['val_type']}_1.5b_select_retrained_{config['dataset_percentage']}/select_{config['percentage']}_peft_model_{config['val_type']}_{config['dataset_percentage']}"
