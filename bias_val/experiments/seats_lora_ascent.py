...
if __name__ == "__main__":
    ...
    adapter_model_dir = f"../bias_sel/opt_{config['val_type']}_1.3b_select_ascent/ascent_{config['val_type']}_mid_model_{config['dataset_percentage']}_{config['percentage']}"
    ...
    if config['model_path']:
      output_path = f"{config['store_path']}/results_mid_select_crows_{config['val_type']}_{config['dataset_percentage']}_retrained/{config['percentage']}/seat_ft.json"
    else:
      output_path = f"{config['store_path']}/results_mid_select_crows_{config['val_type']}_{config['dataset_percentage']}_retrained/{config['percentage']}/seat.json"
