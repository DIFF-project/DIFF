...
# 改这里
parser.add_argument("--output_path", type=str, default='./step2/result_1.3b_crows_val', help="The path to the output")
...
parser.add_argument("--ds", type=str, default="val_data/prompt_data.csv",
                    help="ds")
parser.add_argument("--md_path", type=str, default="./opt_prompt_1.3b_select_ig",
                    help="model path")
...
if __name__ == '__main__':
    ...
    pre_model_name = f'peft_model_{args.dataset_type}_mid'
