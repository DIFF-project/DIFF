...
do
    ...
    # python -m compare_csv_overlap --target ./data/Qwen/${DATA_SIZE}_${DATASET_TYPE} --select ./data/TREX/TREX_data.csv --dataset_type ${DATASET_TYPE} --val_type ${VAL_TYPE} --percentage $p
