...
import numpy as np
import experiments.dataloader as dataloader
output_path = './output/stereoset/results_mid_balance_select_pt/0.15'

def parse_args():
    parser = ArgumentParser()
    parser.add_argument("--gold-file", default=r'./data/stereoset/test.json')
    # parser.add_argument("--predictions-file", default=r'.\output\stereoset\results_mid_gen_peft\stereoset_ft.json')
    parser.add_argument("--predictions-file", default=f'{output_path}/stereoset_ft.json')
...
def parse_file(gold_file, predictions_file):
    ...
    if args.output_file:
        ...
        output_file = f"{output_path}/result_ft.json"
