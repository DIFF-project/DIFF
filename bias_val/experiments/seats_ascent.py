...
if __name__ == "__main__":
    ...
    if config['model_path']:
        ...
        model_path = f"../bias_sel/opt_{config['val_type']}_350m_select_ascent/ascent_{config['val_type']}_small_model_{config['dataset_percentage']}_{config['percentage']}.pth"
    ...
    if config['model_path']:
      output_path = f"{config['store_path']}/results_small_{config['data_type']}_select_{config['val_type']}_{config['dataset_percentage']}/{config['percentage']}/seat_ft.json"
    else:
      output_path = f"{config['store_path']}/results_small_{config['data_type']}_select_{config['val_type']}_{config['dataset_percentage']}/{config['percentage']}/seat.json"
